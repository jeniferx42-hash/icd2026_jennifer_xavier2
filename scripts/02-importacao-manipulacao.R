...
#salva os dados limposem um arquivo rds para análises 
...
dados_vendas_limpos |>
  filter(cidade =="Formiga" & representante == "Representantes 1")
...
# seleciona apenas as colunas cidades, produto e receita
dados_vendas_limpos |>
